...
import { Collectors, Container, Game, Games, Logo, RowAround, Statistics, Title } from './styles'
    ...
    <Container>
      ...
      <RowAround>
        <Row onClick={()=>navigate('/colecionadores')}>
          <Logo src={selected === 'collectors' ? collectorsWhite : collectorsGray} />
          <Collectors selected={selected}>Colecionadores</Collectors>
        </Row>
        <Row onClick={()=>navigate('/jogos')}>
        <Logo src={selected === 'games' ? gamesWhite : gamesGray} />
        <Games selected={selected}>Jogos</Games>
        </Row>
        <Row onClick={()=>navigate('/estatisticas')}>
        <Logo src={selected === 'statistics' ? statisticsWhite : statisticsGray} />
